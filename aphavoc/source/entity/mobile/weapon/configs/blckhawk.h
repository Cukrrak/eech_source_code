...
//
		...
		#define LHS1_CHAFF_DISPENSER (BLACKHAWK_LFHS_CHAFF_DISPENSER)
		#define LHS1_FLARE_DISPENSER (BLACKHAWK_LFHS_FLARE_DISPENSER)
		#define LHS2_CHAFF_DISPENSER (BLACKHAWK_LBHS_CHAFF_DISPENSER)
		#define LHS2_FLARE_DISPENSER (BLACKHAWK_LBHS_FLARE_DISPENSER)
