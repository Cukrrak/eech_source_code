...
//
		...
		#define LHS_CHAFF_DISPENSER (BLACKHAWK_LHS_CHAFF_DISPENSER)
		#define LHS_FLARE_DISPENSER (BLACKHAWK_LHS_FLARE_DISPENSER)
		...
		#define NUM_CHAFFS				(20)
		#define NUM_FLARES				(40)
