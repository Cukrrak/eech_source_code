...
#define DEFAULT_GWUT_FILE "GWUT1162.CSV"
...
static const struct config_option options[] =
{
	...
	{ "mur", "max_update_rate", "max update framerate for a server (not available for client) (n = frames/second) (TCP/IP = 5, IPX = 15) (def = 15)",
...
//		INT(command_line_eo_full_range) },
	...
	{ NULL, NULL, "",
		NONE },
	{ "high_lod_hack", "", "Quality of models at far distances and objects draw distance (Alt + L) (0 = low/default, 5 = high/max) (def = 0)",
		INT(command_line_high_lod_hack) },
	{ "eo_models_quality", "", "Quality of models on the EO screen (Shift + L) (0 = low, 5 = high) (def = 2)",
		INT(command_line_eo_quality) },
	{ "dwash", "downwash", "rotor downwash (dust) (0 = off, 1 = on) (def = 0)",
		INT(command_line_downwash) },
	{ "blurred_rotor_blades", "", "Blurred main rotor blades (Shift + R) (0 = disabled, 1 = enabled) (def = 0)",
	...
	{ "russian_nvg_no_ir", "", "russian night vision has no FLIR (0 = off, 1 = on) (def = 1)",
	...
	{ "advanced_mfd", "", "Alternative MFD symbology (Mi-28, Ka-50, Ka-52) (0 = off, 1 = on) (def = 1)",
		INT(command_line_advanced_mfd) },
	...
	{ "max_smoke_time", "", "Smoke and flame maximum time of life, affects only smokes with larger value (1 = 1 minute, 60 = 1 hour) (def = 30)",
		INT(command_line_max_smoke_time) },
	{ "smoke_optimization", "", "Smoke generators quantity optimization (0 = disabled, 1 = enabled) (def = 1)",
		INT(command_line_smoke_optimization) },
	...
	{ "dyad", "command_line_dynamics_air_density", "global air density modifier (0.5 - increase dynamics ceiling, 2.0 - decrease) (default = 1.0)",
		FLOAT(command_line_dynamics_air_density) },
	{ NULL, NULL, "",
		NONE },
	...
	{ "collectiveax", "collective_joystick_axis", "Joystick DirectX axis for the collective",
		SPECINT(command_line_collective_joystick_axis, set_axis, get_axis) },
	{ "throttlen", "throttle_joystick_index", "Joystick no. for the engines throttle",
		INT(command_line_throttle_joystick_index) },
	{ "throttleax", "throttle_joystick_axis", "Joystick DirectX axis for the engines throttle",
		SPECINT(command_line_throttle_joystick_axis, set_axis, get_axis) },
	{ "reverse_throttle", "", "Reversed throttle input (0 = off, 1 = on) (def = 0)",
		INT(command_line_reverse_throttle) },
	...
	{ "ffb_recoil", "", "power of force feedback effects related to weapon recoil (when forcefeedback forcefeedback= 1) (0 = off, 1 = normal gain) (def = 0.5)",
	...
	{ "autosave", "", "autosave (n = minutes, 0 = off) (def = 30)",
		SPEC(set_autosave, get_autosave) },
	{ "saves_copies", "", "how much backup copies of save files to keep (0 = no backup, n = number of copies) (def = 0)",
	...
	{ "goto", "planner_goto_button", "\"GOTO\" (teleport) functionality on campaign map (cheat) (0 = off, 1 = on) (def = 0)",
	...
	{ "radio_msgs_noise", "", "radio messages volume and pitch control (0 = off, 1 = on) (def = 1)",
		INT(command_line_radio_msgs_noise) },
	{ "ui_sounds_muted", "", "campaign UI mute (0 = normal UI sounds, 1 = UI sounds muted) (default = 0)",
		INT(command_line_ui_sounds_muted) },
	{ "complete_music", "", "mission complete music (0 = off, 1 = on) (def = 1)",
		INT(command_line_mission_complete_music) },
	{ "intro_music", "", "intro music (0 = off, 1 = on) (def = 1)",
		INT(command_line_intro_music) },
	{ "ingame_music", "", "ingame music (0 = off, 1 = on) (def = 1)",
		INT(command_line_ingame_music) },
	{ "action_music", "", "action music (0 = off, 1 = on) (def = 1)",
		INT(command_line_action_music) },
	{ NULL, NULL, "",
		NONE },
