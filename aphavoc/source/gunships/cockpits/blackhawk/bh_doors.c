...
void toggle_blackhawk_canopy_doors(event* ev)
{
...
void initialise_blackhawk_virtual_cockpit_canopy_doors (void)
{
...
void animate_blackhawk_virtual_cockpit_canopy_doors (void)
{
	float
		aiming_state;
