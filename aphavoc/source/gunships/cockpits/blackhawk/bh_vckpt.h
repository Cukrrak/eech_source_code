...
extern void initialise_blackhawk_virtual_cockpit (void);

extern void deinitialise_blackhawk_virtual_cockpit (void);

extern void update_blackhawk_virtual_cockpit (void);
