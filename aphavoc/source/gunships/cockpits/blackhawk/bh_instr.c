...
void get_blackhawk_virtual_cockpit_adi_angles (matrix3x3 attitude, float *heading, float *pitch, float *roll)
{
	matrix3x3
		inverse_attitude,
		heading_rotation,
...
float get_blackhawk_virtual_cockpit_adi_slip_indicator_needle_value (void)
{
	float
		slip_needle_value;
...
float get_blackhawk_virtual_cockpit_airspeed_indicator_needle_value (void)
{
	float
		airspeed_needle_value,
		fraction,
...
void get_blackhawk_virtual_cockpit_clock_hand_values (float *hours, float *minutes, float *seconds)
{
	float
		hour_hand_value,
		minute_hand_value,
