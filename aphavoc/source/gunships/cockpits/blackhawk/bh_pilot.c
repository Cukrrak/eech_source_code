...
{
	read_motion_values ("GRAPHICS\\COCKPITS\\BLACKHAWK\\JOYSTICK.MOT", NUM_RIGHT_ARM_FRAMES, right_arm_joystick_motion);

	read_motion_values ("GRAPHICS\\COCKPITS\\BLACKHAWK\\FOREARM.MOT", NUM_RIGHT_ARM_FRAMES, right_arm_forearm_motion);

	read_motion_values ("GRAPHICS\\COCKPITS\\BLACKHAWK\\SHOULDER.MOT", NUM_RIGHT_ARM_FRAMES, right_arm_shoulder_motion);
}
...
void initialise_blackhawk_pilot_animation (void)
{
	#if DEBUG_MODULE
...
void deinitialise_blackhawk_pilot_animation (void)
{
...
void update_blackhawk_pilot_animation (void)
{
...
void set_blackhawk_pilot_head_position (void)
{
	int
		show_pilot_head;
...
float get_blackhawk_pilot_head_pitch_datum (void)
{
	float
		relative_pitch;
