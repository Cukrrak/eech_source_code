...
void initialise_blackhawk_co_pilot_animation (void)
{
	#if DEBUG_MODULE
...
void deinitialise_blackhawk_co_pilot_animation (void)
{
}
...
void update_blackhawk_co_pilot_animation (void)
{
...
void set_blackhawk_co_pilot_head_position (void)
{
	int
		show_co_pilot_head;
...
float get_blackhawk_co_pilot_head_pitch_datum (void)
{
	float
		relative_pitch;
