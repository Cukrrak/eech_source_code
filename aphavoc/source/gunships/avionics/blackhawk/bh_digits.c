...
void update_chrono (void)
{
	...
	set_chrono_display_text (chrono_line1, chrono_line2);
}
...
void initialise_blackhawk_digital_displays (void)
{
...
void deinitialise_blackhawk_digital_displays (void)
{
...
void update_blackhawk_digital_displays (void)
{
	update_chrono ();
}
...
void draw_blackhawk_digital_display_on_texture (void)
{
