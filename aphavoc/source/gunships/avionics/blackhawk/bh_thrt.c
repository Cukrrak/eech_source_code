...
void initialise_blackhawk_threat_warning_system (void)
{
...
void deinitialise_blackhawk_threat_warning_system (void)
{
...
void activate_blackhawk_threat_warning_system (entity *threat)
{
	ASSERT (threat);
