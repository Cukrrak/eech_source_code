...
float
	blackhawk_stinger_seeker_head_x_position,
	blackhawk_stinger_seeker_head_y_position;



void initialise_blackhawk_weapon_systems (void)
{
	seeker_head_theta1 = 0.0;

	seeker_head_theta2 = 0.0;

	blackhawk_stinger_seeker_head_x_position = 0.0;

	blackhawk_stinger_seeker_head_y_position = 0.0;
}
...
void update_blackhawk_weapon_systems (void)
{
	int
		inhibit_launch;
	...
	blackhawk_stinger_seeker_head_x_position = 0.25 * sin (seeker_head_theta1);
	blackhawk_stinger_seeker_head_y_position = 0.25 * cos (seeker_head_theta1);

	blackhawk_stinger_seeker_head_x_position += 0.125 * sin (seeker_head_theta2);
	blackhawk_stinger_seeker_head_y_position += 0.125 * cos (seeker_head_theta2);
...
float get_blackhawk_missile_flight_time (void)
{
	entity_sub_types
		weapon_sub_type;
...
void toggle_blackhawk_infra_red_jammer_manual (void)
{
	...
	play_common_cpg_infra_red_jammer_speech (blackhawk_damage.infra_red_jammer);
}
...
void set_blackhawk_infra_red_jammer_manual (int state)
{
	if (!blackhawk_damage.infra_red_jammer)
	{
		if (!get_global_auto_counter_measures ())
...
void set_blackhawk_infra_red_jammer_auto (int state)
{
	if (!blackhawk_damage.infra_red_jammer)
	{
		if (get_global_auto_counter_measures ())
